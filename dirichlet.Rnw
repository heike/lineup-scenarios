...
\citet{Cheng:2013} utilise lineups to examine mountaineering.
...
\citet{zhao:2014}examined how people read lineups, using an eyetracker. \citet{Healy:2014} summarises the importance for sociology researchers.
